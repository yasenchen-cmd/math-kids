...
const characters = {
  number_sense: {
    ...
    lines: {
      ...
      retry_correct: ['对啦！坚持就是胜利！💪', '再试一次就对了，好棒！', '你看，认真想就能对！✨'],
  ...
  patterns: {
    ...
    lines: {
      ...
      retry_correct: ['找到了！这次你看对了！👏', '规律找到了，真不错！', '再试就对了，聪聪为你鼓掌！'],
  ...
  addition: {
    ...
    lines: {
      ...
      retry_correct: ['对啦！嘟嘟就知道你可以！🍯', '再试一次就对了，真棒！', '坚持对了，给你点赞！👍'],
  ...
  subtraction: {
    ...
    lines: {
      ...
      retry_correct: ['耶！这次对了！💪', '再试就成功啦，好棒！', '果果看到你在努力！'],
  ...
  geometry: {
    ...
    lines: {
      ...
      retry_correct: ['飞起来啦！这次对了！🌈', '再试就对了，飞飞为你开心！', '坚持思考，答对啦！✨'],
  ...
  multiplication: {
    ...
    lines: {
      ...
      retry_correct: ['喵～这次对了！', '再试就对了，还不错嘛～', '咪咪看到你在认真想！👏'],
  ...
  advanced: {
    ...
    lines: {
      ...
      retry_correct: ['这次对了，很好。💪', '再试就答对了，继续加油。', '坚持思考，值得表扬。'],
  ...
  minnan_secret: {
    ...
    lines: {
      ...
      retry_correct: [
        '水啦！再试就对咯！(Súi--lah! Koh tshì tio̍h--looh) 💪',
        '贺！汝有认真想！(Hō! Lí ū jīn-tsng siūnn)',
        '好啊！这次对了！(Hó--ah! Tsit-pái tio̍h--ah)',
      ],
      wrong: [
